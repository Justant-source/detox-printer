...
- **Prototype**: Writing UI or logic code to test a hypothesis, or to explore a design space. Uses the /mattpocock-skills:prototype skill. Creates a prototype as an asset. Use this when "how should it look" or "how should it behave" is the key question.
- **Discuss**: Conversation with the agent. Uses the /mattpocock-skills:grilling and /mattpocock-skills:domain-modeling skills. The default case.
...
1. Run a /mattpocock-skills:grilling and /mattpocock-skills:domain-modeling session to surface the open decisions.
...
2. Run a session to resolve the ticket, invoking skills as needed. If in doubt, use `/mattpocock-skills:grilling` and `/mattpocock-skills:domain-modeling`.
...
If they skip it, you should recommend implementing directly.
